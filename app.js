...
var taskInput=document.querySelector(".tasks-add .tasks__edit");//Add a new task.
var addButton=document.querySelector(".tasks-add .tasks__change");//first button
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="tasks__edit";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="tasks__change";
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('.tasks__edit');
    var label=listItem.querySelector(".tasks__name");
    var editBtn=listItem.querySelector(".tasks__change");
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector(".tasks__change");
    var deleteButton=taskListItem.querySelector(".button");
